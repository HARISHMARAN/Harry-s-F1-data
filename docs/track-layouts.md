# Track Layout Sources (SVG)

These SVG track outlines are from OpenClipart (CC0 / public domain) and hosted
on Wikimedia Commons or OpenClipart. Attribution is optional, but we list the
sources here for clarity.

- Monaco — https://commons.wikimedia.org/wiki/File:F1_circuits_2014-2018_-_Circuit_de_Monaco_(version_2).svg
- Monza — https://commons.wikimedia.org/wiki/File:F1_circuits_2014-2018_-_Autodromo_Nazionale_Monza_(version_2).svg
- Melbourne (Albert Park) — https://commons.wikimedia.org/wiki/File:F1_circuits_2014-2018_-_Melbourne_Grand_Prix_Circuit_(version_2).svg
- Circuit of the Americas — https://commons.wikimedia.org/wiki/File:F1_circuits_2014-2018_-_Circuit_of_the_Americas_(version_2).svg
- Silverstone — https://commons.wikimedia.org/wiki/File:F1_circuits_2014-2018_-_Silverstone_(version_2).svg
- Spa-Francorchamps — https://commons.wikimedia.org/wiki/File:F1_circuits_2014-2018_-_Circuit_de_Spa-Francorchamps_(version_2).svg
- Bahrain — https://commons.wikimedia.org/wiki/File:Remix_of_F1_circuits_2014-2018_-_Bahrain_International_Circuit_(version_2).svg
