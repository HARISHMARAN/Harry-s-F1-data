...
const JOLPICA_BASE = 'https://api.jolpi.ca/ergast/f1/current/last/results.json';
...
export async function fetchHistoricalData() {
  try {
    const response = await fetch(JOLPICA_BASE);
